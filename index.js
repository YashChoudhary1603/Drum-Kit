...
function makeSound(key) {
  switch (key) {
    case "w":
      var tom1 = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/tom-1.mp3");
      tom1.play();
      break;
    case "s":
      var tom2 = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/tom-2.mp3");
      tom2.play();
      break;
    case "a":
      var tom3 = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/tom-3.mp3");
      tom3.play();

      break;

    case "d":
      var tom4 = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/tom-4.mp3");
      tom4.play();

      break;

    case "j":
      var snare = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/snare.mp3");
      snare.play();
      break;

    case "k":
      var crash = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/crash.mp3");
      crash.play();
      break;

    case "l":
      var kick = new Audio("https://github.com/YashChoudhary1603/Drum-Kit/blob/master/sounds/kick-bass.mp3");
      kick.play();
      break;
